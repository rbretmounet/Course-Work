// Lab5_Raphael_Bret-Mounet.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
#include <ctime>
using namespace std;
void randomIntegers(SortableBag<int> &); // Function used to genereate random numbers and fill the object.
...
{ 
    ...
    randomIntegers(numbers); // Generates random numbers.

    vector<int> Numbers = numbers.toVector(); // Grabs unsorted numbers

    cout << "Requesting sort..." << endl;
    numbers.sort(); // Sorts random numbers in ascending order.
...
void randomIntegers(SortableBag<int> &randomNumbers) {
...
{
    cout << "The bag contains 100 items:" << endl;
    cout << endl;
